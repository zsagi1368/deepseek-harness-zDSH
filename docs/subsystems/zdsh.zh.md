...
源接缝：[`packages/llm/model-slots`](../../packages/llm/model-slots)、[`packages/host/plugin-governance-host`](../../packages/host/plugin-governance-host)、[`packages/plugins/plugin-project-root`](../../packages/plugins/plugin-project-root)。
