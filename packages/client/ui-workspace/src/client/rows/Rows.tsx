...
export function ProjectRowItem({ group, onToggle, onCreate, actions, drag, home, t }: {
  ...
  actions?: {
    rename: () => void
    delete: () => void
    /** Reveal the Workspace directory in the file manager; offered when the host can. */
  ...
  const workspaceMenuItems = [
    ...(actions?.reveal === undefined ? [] : [{ id: 'reveal', label: t('menu.reveal'), icon: <IconFolderOpenOutline16 /> }]),
