...
export const en = {
  ...
  fetchInvertSelection: 'Invert selection',
  ...
  reasoningEffortHint: 'Applied as the route default for models that support reasoning; each session can still override it per model from the composer picker.',
  effortOff: 'Off',
  ...
  slotsTitle: 'Auxiliary model slots',
  slotsIntro: 'Side tasks (titles, compaction summaries, image descriptions) use their own route when one is configured; otherwise they follow the conversation model.',
  slotsEmpty: 'No auxiliary slots are configured; every side task follows the conversation model.',
  slotTitle: 'Title generation',
  slotCompaction: 'Compaction summary',
  slotVision: 'Vision assist',
  slotUnset: 'Not configured',
  slotProvider: 'Provider',
  slotModel: 'Model',
  slotSourceExplicit: 'Explicit slot configuration',
  slotSourceDeploymentDefault: 'Deployment default',
  slotSourceMainRoute: 'Main model route',
  slotSourceMainRouteHint: 'Resolved per conversation; the page cannot show a fixed route.',
  slotSourceDescription: 'Resolved as: explicit slot configuration, then the deployment default, then the main model route.',
  slotCredentialRef: 'Uses {ref}',
  visionEdit: 'Edit vision slot',
  visionSave: 'Save vision slot',
  visionSaving: 'Saving…',
  visionCancel: 'Cancel',
  visionProviderLabel: 'Vision provider',
  visionModelLabel: 'Vision model',
  visionModelPlaceholder: 'Model ID',
  visionKeyHint: 'Credential reference: {ref}',
  visionKeyRefOnly: 'The credential is referenced by the environment-variable name above; no API key is stored here.',
  visionNoProviders: 'No providers are configured yet; configure a provider above first.',
  visionRouteRequired: 'Enter both a provider and a model for the vision slot.',
  visionModelImageRequired: 'This model does not declare image input. Choose a model that accepts images, or the vision slot cannot read pictures.',
  visionModelUnverified: 'The provider could not confirm this model accepts image input; the write was refused.',
  visionValidating: 'Checking this model can read images…',
  visionSaved: 'Saved the vision slot.',
  visionUnset: 'Clear vision slot',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  reasoningEffortDefault: '提供方默认',
  reasoningEffortHint: '作为该渠道支持推理的模型的默认强度；会话内仍可在输入区的模型选择器中按模型调整。',
  effortOff: '关闭',
  effortMinimal: '极低',
  effortLow: '低',
  effortMedium: '中',
  ...
  slotsTitle: '辅助模型槽位',
  slotsIntro: '侧任务（标题生成、压缩摘要、图片描述）有独立配置时使用自身路由，否则跟随会话主模型。',
  slotsEmpty: '未配置辅助模型槽位，所有侧任务跟随会话模型。',
  slotTitle: '标题生成',
  slotCompaction: '压缩摘要',
  slotVision: '视觉辅助',
  slotUnset: '未配置',
  slotProvider: '提供方',
  slotModel: '模型',
  slotSourceExplicit: '显式槽位配置',
  slotSourceDeploymentDefault: '部署默认',
  slotSourceMainRoute: '主模型路由',
  slotSourceMainRouteHint: '跟随会话主模型，页面无法展示固定路由。',
  slotSourceDescription: '解析顺序：显式槽位配置 > 部署默认 > 主模型路由。',
  slotCredentialRef: '使用 {ref}',
  visionEdit: '编辑视觉槽位',
  visionSave: '保存视觉槽位',
  visionSaving: '保存中…',
  visionCancel: '取消',
  visionProviderLabel: '视觉提供方',
  visionModelLabel: '视觉模型',
  visionModelPlaceholder: '模型 ID',
  visionKeyHint: '凭据引用：{ref}',
  visionKeyRefOnly: '凭据引用由上方环境变量名定义，此处不存储 API 密钥。',
  visionNoProviders: '尚未配置任何提供方，请先在模型页面上方配置。',
  visionRouteRequired: '请输入视觉槽位的提供方和模型。',
  visionModelImageRequired: '该模型不支持图片输入，请选择支持图片的模型，否则视觉槽位无法读取图片。',
  visionModelUnverified: '提供方无法确认该模型支持图片输入，写入已拒绝。',
  visionValidating: '正在检查模型是否支持图片…',
  visionSaved: '视觉槽位已保存。',
  visionUnset: '清除视觉槽位',
}
