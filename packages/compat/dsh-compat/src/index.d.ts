 ...
 */
export { probeSymbol, memberOf, versionOf, } from './probe.ts';
export type { ProbeResult, ProbeReason, } from './probe.ts';
export { guardFeature, getCompatRoster, consoleCompatLogger, } from './guard.ts';
export type { CompatCheck, CompatLogger, FeatureVerdict, GuardFeatureOptions, } from './guard.ts';
