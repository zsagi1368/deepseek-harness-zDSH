 ...
 */
export declare function consoleCompatLogger(): CompatLogger;
 ...
 */
export declare function getCompatRoster(): ReadonlyMap<string, Readonly<CompatRosterEntry>>;
/**
 ...
 */
export declare function guardFeature(featureId: string, options: GuardFeatureOptions): Promise<FeatureVerdict>;
