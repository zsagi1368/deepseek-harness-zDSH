...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CordisDynamicExportId: 'dynamic Plugin export request identity is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisExportReceipt: 'dynamic Plugin export confirmation receipt is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisExportSettlementFailure: 'dynamic Plugin export settlement failure detail is owned by packages/extensions/cordis-host-runner/src/types.ts',
  SlotId: 'auxiliary model slot identity is owned by packages/llm/model-slots/src/vocabulary.ts',
  ModelRoute: 'auxiliary model provider/model route is owned by packages/llm/model-slots/src/index.ts',
  ModelSlotResolveInput: 'model slot resolution input is owned by packages/llm/model-slots/src/index.ts',
  ResolvedModelSlot: 'resolved auxiliary model slot outcome is owned by packages/llm/model-slots/src/index.ts',
  CordisExportRequestSummary: 'dynamic Plugin export request summary is owned by packages/extensions/cordis-host-runner/src/types.ts',
  CordisExportRequestResolved: 'dynamic Plugin export resolution receipt is owned by packages/extensions/cordis-host-runner/src/types.ts',
