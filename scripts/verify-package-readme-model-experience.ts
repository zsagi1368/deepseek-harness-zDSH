...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/llm/model-slots': { kind: 'indirect', reason: 'The registry only selects the provider/model pair each auxiliary dispatch uses; request assembly and adapters own everything the model sees.' },
